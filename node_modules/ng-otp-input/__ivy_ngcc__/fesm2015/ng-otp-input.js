...
function NgOtpInputComponent_div_0_input_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function NgOtpInputComponent_div_0_input_1_Template_input_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r782); const ctx_r781 = ɵngcc0.ɵɵnextContext(2); return ctx_r781.onKeyDown($event); })("keyup", function NgOtpInputComponent_div_0_input_1_Template_input_keyup_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r782); const i_r780 = ctx.index; const ctx_r783 = ɵngcc0.ɵɵnextContext(2); return ctx_r783.onKeyUp($event, i_r780); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r779 = ctx.$implicit;
    const i_r780 = ctx.index;
    const ctx_r778 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵclassMapInterpolate1("otp-input ", ctx_r778.config.inputClass, "");
    ɵngcc0.ɵɵpropertyInterpolate2("id", "otp_", i_r780, "_", ctx_r778.componentKey, "");
    ɵngcc0.ɵɵproperty("pattern", ctx_r778.config.allowNumbersOnly ? "\\d*" : "")("type", ctx_r778.inputType)("placeholder", (ctx_r778.config == null ? null : ctx_r778.config.placeholder) || "")("disabledNumberOnly", !ctx_r778.config.allowNumbersOnly)("ngStyle", ctx_r778.config.inputStyles)("formControl", ctx_r778.otpForm.controls[item_r779]);
} }
function NgOtpInputComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassMapInterpolate1("wrapper ", ctx_r777.config.containerClass, "");
    ɵngcc0.ɵɵpropertyInterpolate1("id", "c_", ctx_r777.componentKey, "");
    ɵngcc0.ɵɵproperty("ngStyle", ctx_r777.config.containerStyles);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ɵngcc0.ɵɵpipeBind1(2, 6, ctx_r777.otpForm == null ? null : ctx_r777.otpForm.controls));
} }
class KeysPipe {
    /**
     * @param {?} value
